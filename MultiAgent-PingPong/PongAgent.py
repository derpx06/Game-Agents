...
class PongAgent:
    def __init__(self, state_size=8, action_size=3, sequence_length=4, lr=0.0001, gamma=0.99, buffer_capacity=200000,
        ...
        # Use the new Convolutional Dueling DQN
    ...
    def choose_action(self, stacked_state):
        ...
        # Reshape state for ConvNet: (1, seq_len, state_features)
